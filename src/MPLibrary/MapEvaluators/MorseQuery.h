...
pair<double, double>
MorseQuery<MPTraits>::
calculateWaitTime(vector<VID>& _segment, double startTick, vector<double>& _waitTimes, int r_speed) {// Function calculates total wait time needed for a path segment
