...
class MedialAxis2D {
  ...
  public:
    ...
    typedef unordered_map<WorkspaceSkeleton::VD, std::vector<ClearanceType> >
    ...
    typedef vector<pair<double,pair<Point3d,Point3d>>> EdgeClearanceType;
    typedef unordered_map<WorkspaceSkeleton::ED, EdgeClearanceType, 
    ...
    EdgeClearanceType AnnotateSegment(MedialEdge& _e);
  ...
  private:
    ...
    /// Function to simpilfy a skeleton graph by removing degree 2 vertices
    void RemoveDegree2(SkeletonGraphType& _g, VertexClearanceMapType& _vmap, EdgeClearanceMapType& _emap);
