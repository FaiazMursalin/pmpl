...
#endif
{
  ...
  public:
    ...
    void AddEdge(const VID _source, const VID _target, const Edge& _w, bool override=false) noexcept;
...
void
RoadmapGraph<Vertex, Edge>::
AddEdge(const VID _source, const VID _target, const Edge& _w, bool override) noexcept {
#ifdef VIZMO
